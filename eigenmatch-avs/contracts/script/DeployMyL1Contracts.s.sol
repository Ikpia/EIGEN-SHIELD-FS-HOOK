...
contract DeployMyL1Contracts is Script {
    ...
    function run(string memory environment, string memory _context) public {
        ...
        EigenShieldDigestRegistry registry = new EigenShieldDigestRegistry(context.avs);
        console.log("EigenShieldDigestRegistry deployed to:", address(registry));
        ...
        outputs[0] = Output({name: "EigenShieldDigestRegistry", contractAddress: address(registry)});
